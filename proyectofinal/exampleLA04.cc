/* 
 * exampleLA04.cc: Simulación de ejemplo en Geant4.
 * 
...
int main(int argc,char** argv)
{
  ...
  runManager->SetUserInitialization(new LA04DetectorConstruction());
  ...
  runManager->SetUserInitialization(new LA04ActionInitialization());
